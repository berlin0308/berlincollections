...
class Calculator(tk.Frame):
  ...
  def createWidgets(self):
    ...
    self.btnNum1 = tk.Button(self, text = "1", height = 1, width = 2, bg = "black",fg = "white",command = self.clickBtnNum1, font = f2) 
    ...
    self.imageSqrt = ImageTk.PhotoImage(file = "C:\\Users\\BERLIN CHEN\\Desktop\\BC- Python\\sqrt.png")
