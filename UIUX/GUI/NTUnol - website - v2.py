...
CourseDict = dict(list())  #CourseDict[serialNum] = [courseNum,classNum,courseName,credit,identifier,period,prof,regisAppr,sesstring,addsesstring,moresesstring,classroom,studentNum,field,courseLink]
